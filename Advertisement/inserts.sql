...
(1, 1, 'posted', 'Nowoczesne mieszkanie w centrum', 1, 1, 1),
(2, 2, 'pending', 'Stylowe mieszkanie w sercu miasta', 2, 2, 2),
(3, 3, 'posted', 'Dom z ogrodem na przedmieściach', 3, 3, 3),
(4, 4, 'ended', 'Dom z garażem i basenem', 4, 4, 4),
(5, 5, 'canceled', 'Przytulny pokój na wynajem', 5, 5, 5),
(6, 6, 'suspended', 'Duży apartament z balkonem', 6, 6, 6),
(7, 7, 'posted', 'Ekskluzywny dom w prestiżowej lokalizacji', 7, 7, 7),
(8, 8, 'pending', 'Przestronny pokój w świetnej lokalizacji', 8, 8, 8),
(9, 9, 'posted', 'Willa z widokiem na góry', 9, 9, 9),
(10, 10, 'ended', 'Mieszkanie do remontu w świetnej cenie', 10, 10, 10)
RETURNING *;
...
(10.00, 1, 'ended'),      -- Powiązane z AdvertisementId 1
(15.50, 2, 'pending'),     -- Powiązane z AdvertisementId 2
(20.00, 3, 'ended'),      -- Powiązane z AdvertisementId 3
(10.00, 4, 'suspended'),  -- Powiązane z AdvertisementId 4
(25.00, 5, 'ended'),      -- Powiązane z AdvertisementId 5
(50.00, 6, 'pending'),     -- Powiązane z AdvertisementId 6
(12.00, 7, 'suspended'),  -- Powiązane z AdvertisementId 7
(30.00, 8, 'ended'),      -- Powiązane z AdvertisementId 8
(8.00, 9, 'pending'),     -- Powiązane z AdvertisementId 9
(40.00, 10, 'ended')      -- Powiązane z AdvertisementId 10
RETURNING *;