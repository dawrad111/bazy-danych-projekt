...
VALUES
(1500, 600, 300, 2500, 'lump', 'Private'),
(1200, 500, 200, 1500, 'monthly', 'Agency'),
(2000, 800, 350, 2500, 'yearly', 'Private'),
(1000, 800, 300, 2100, 'lump', 'Private'),
(2200, 900, 200, 3100, 'lump', 'Agency'),
(2700, 900, 500, 4300, 'yearly', 'Agency'),
;
...
(3, 20.0, 30.0, 15.0),
(1, 10.0, 20.0, 8.0),
(2, 2, 15.0, 25.0, 12.0),  -- Pasuje do rekordu w Object o id = 2, typeId = 4
(4, 3, 20.0, 30.0, 15.0),  -- Pasuje do rekordu w Object o id = 4, typeId = 5
(6, 1, 10.0, 20.0, 8.0),   -- Pasuje do rekordu w Object o id = 6, typeId = 6
(8, 2, 12.5, 18.0, 10.0),  -- Pasuje do rekordu w Object o id = 8, typeId = 7
(10, 3, 22.0, 35.0, 20.0), -- Pasuje do rekordu w Object o id = 10, typeId = 8
(12, 2, NULL, 15.0, 25.0), -- Przykład bez poddasza, pasuje do Object id = 12
(14, 1, 8.0, NULL, 30.0),  -- Przykład bez tarasu, pasuje do Object id = 14
(16, 4, 25.0, 40.0, 50.0), -- Duży dom, pasuje do Object id = 16
(18, 2, 14.0, 22.0, 18.0), -- Średniej wielkości, pasuje do Object id = 18
(20, 3, 18.0, 28.0, 35.0); -- Pasuje do Object id = 20
