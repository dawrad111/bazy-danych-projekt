...
-- VALUES
-- ('Alice', 'Smith', 'hash1234', 6, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user', 'active', FALSE),
-- ('John', 'Doe', 'hash5678', 7, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'administrator', 'active', TRUE),
-- ('Eva', 'Brown', 'hash91011', 8, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user', 'suspended', FALSE),
-- ('Lucas', 'Johnson', 'hash1213', 9, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'operator', 'active', TRUE),
-- ('Marta', 'Kowalska', 'hash1415', 10, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user', 'active', TRUE),
-- ('Adam', 'Nowak', 'hash1617', 11, 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'operator', 'active', TRUE),
-- ('Kasia', 'Wójcik', 'hash1819', 12, 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user', 'suspended', FALSE),
-- ('Paul', 'White', 'hash2021', 13, 9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user', 'active', TRUE),
-- ('Anna', 'Adams', 'hash2223', 14, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user', 'active', FALSE),
-- ('Peter', 'Smith', 'hash2425', 15, 11, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'administrator', 'active', TRUE);

-- INSERT INTO PhoneNumber (phoneNumber, code, linkExpiredDate, isVerified, verifiedDate)
-- VALUES
...
-- INSERT INTO Email (email, link, linkExpiredDate, isVerified, verifiedDate)
-- VALUES
...
-- VALUES
-- (12, 'login', CURRENT_TIMESTAMP),
-- (11, 'logout', CURRENT_TIMESTAMP),
-- (13, 'comment', CURRENT_TIMESTAMP),
